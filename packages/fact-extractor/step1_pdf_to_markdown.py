...
def generate_unique_markdown_filename(pdf_path):
    ...
    Sanitizes the PDF filename to ensure safe filesystem usage.
    Format: sanitized_name_YYYYMMDD_HHMMSS.md

    Examples:
        Input: "NATARBORA PESIA as submitted 2025-02-10.pdf"
        Output: "NATARBORA_PESIA_as_submitted_2025-02-10_20251116_103053.md"
    """
    pdf_name = extract_base_name(pdf_path)  # Get sanitized filename without extension
