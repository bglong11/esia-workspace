...
<head>
    ...
    <style>
        ...
        * {{ box-sizing: border-box; margin: 0; padding: 0; }}
        ...
        /* Page Cards CSS for Document Factsheet - REMOVED (section disabled) */
...
'''
    ...
    # Document Factsheet Section (Page-based) - REMOVED PER USER REQUEST
    # This section has been commented out to remove the Document Factsheet from the analysis HTML
    ...
    # Factsheet section code removed here (lines 1060-1177)
    # To re-enable, uncomment the code block that generates the Document Factsheet section
...
'''
    ...
    <script>
        ...
        // Document Factsheet JavaScript functions removed (section disabled)
        // Functions removed: togglePageCard, toggleSource, openSidePanel, closeSidePanel
